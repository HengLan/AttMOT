...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--data_dir', type=str, default='/data/resources')
    ...
    self.parser.add_argument('--attr_weight', type=float, default=0.5,
                             help='loss weight for semantic attributes')
