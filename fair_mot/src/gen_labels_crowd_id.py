...
if __name__ == '__main__':
    data_val = '/data/resources/crowdhuman/images/val'
    label_val = '/data/resources/crowdhuman/labels_with_ids/val'
    ann_val = '/data/resources/crowdhuman/annotation_val.odgt'
    data_train = '/data/resources/crowdhuman/images/train'
    label_train = '/data/resources/crowdhuman/labels_with_ids/train'
    ann_train = '/data/resources/crowdhuman/annotation_train.odgt'
