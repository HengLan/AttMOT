...
if __name__ == '__main__':
    data_val = '/data/fair_mot/dataset/crowdhuman/images/val'
    label_val = '/data/fair_mot/dataset/crowdhuman/labels_with_ids/val'
    ann_val = '/data/fair_mot/dataset/crowdhuman/annotation_val.odgt'
    data_train = '/data/fair_mot/dataset/crowdhuman/images/train'
    label_train = '/data/fair_mot/dataset/crowdhuman/labels_with_ids/train'
    ann_train = '/data/fair_mot/dataset/crowdhuman/annotation_train.odgt'
